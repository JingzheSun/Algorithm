...
// GSMNetwork - client program to test reduction of VertexColor to SAT. 
...
public class GSMNetwork {
	...
	public void run() {
		...
		Convert3ColorToSat sat = new Convert3ColorToSat(g);
...
class Convert3ColorToSat {
	...
	/**
	 * Add clause for the following constraint vertex should be of some color
	 */
	...
	/**
	 * add clause for following constraint no two edges belong to same color
	 */
	...
	private void computeSat() {
		...
		// add clause for every edge in graph to satisfy constraint no two edges
		// belong to same color
