...
/**
 * CleaningApartment - client program to test reduction of Hamiltonian Path to SAT.
 */
...
class ConvertHamilPathToSat {
	...
	/**
	 * Routine to add clauses with the following constraint (only one value from
	 * the values array can be true)
	 *
	 * @param values
	 */
	...
	/**
	 * Add clause for the following constraint one vertex in each position in
	 * hamilPath
	 */
	...
	/**
	 * Add clause for the following constraint vertex should be visited only
	 * once in hamilPath
	 */
	...
	/**
	 * Add clause for the following constraint vertices not sharing an edge
	 * should not be part of successive positions in hamilPath
	 */
	...
	private void computeSat() {
		...
		// add clause for each vertex must be visited only once/ all vertices
		// must be on path
		addVertexPositionConstraint();
		// add clause for every edge in graph to satisfy constraint of vertices
		// not belonging to edge not part of successive positions
